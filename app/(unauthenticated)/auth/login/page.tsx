            ...
            <form action={login} className="mt-8 space-y-4">
              <div>
                ...
                <div className="relative flex items-center">
                  <input name="email" type="text" required className="w-full text-gray-800 text-sm border border-gray-300 px-4 py-3 rounded-md outline-blue-600" placeholder="Enter user name" />
              ...
              <p className="text-gray-800 text-sm !mt-8 text-center">Don't have an account? <Link href="/auth/signup">Signup</Link></p>
            </form>
          </div>
        </div>
      </div>
